...
?>
	...
	<div class="col-sm-4 text-justify">
      ...
      <p style="color:white;"><strong>Address:&nbsp;</strong>Kenya, Nairobi</p>
      <p style="color:white;"><strong>Email-Id:&nbsp;</strong>mubarakabdrhman@gmail.com</p>
      <p style="color:white;"><strong>Contact Us:&nbsp;</strong>(+254) 723983214</p><br><br><br>
	</div>&nbsp;
...
<footer class="container-fluid text-center"style="background-color:#000408;height:40px;padding-top:10px;color:#f0f0f0;">
  <p>Developed By CUEA Team@ | All Rights Reserved 2020</p>
</footer>
